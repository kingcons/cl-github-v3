...
creates a new repo for the given ORGANIZATION.")
  ...
  (cl-github:api-command (if org
                             (cl-github:rel-path "/orgs/~A/repos" org)
                             "/user/repos")
               :method :post
               :body parameters))
...
(define-github-command get-branch (owner repo branch)
  ...
  (cl-github:api-command (cl-github:rel-path "/repos/~A/~A/branches/~A" owner repo branch)
                         :method :get))
