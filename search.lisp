...
NOTE: This is a legacy API call.")
  (cl-github:api-command (cl-github:rel-path "/legacy/issues/search/~A/~A/~A/~A"
...
the given PAGE of results. NOTE: This is a legacy API call.")
  (cl-github:api-command (cl-github:rel-path "/legacy/repos/search/~A" keyword)
...
given PAGE of results. NOTE: This is a legacy API call.")
  (cl-github:api-command (cl-github:rel-path "/legacy/users/search/~A" keyword)
                         :method :get :body parameters))
